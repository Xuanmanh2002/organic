        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-7">
                <div class="row">
                    ...
                    $sql = "SELECT COUNT(*) AS total FROM tbl_product WHERE catID = 6";
                    ...
                    $sql = "SELECT * FROM tbl_product WHERE catID = 6 ORDER BY productID DESC LIMIT $start_index, $results_per_page";
                    $qr = mysqli_query($conn, $sql);
                    if ($qr) {
                        $i = 0;
                        while ($row = mysqli_fetch_array($qr)) {
